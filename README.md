...
![Распределение метрик чека](invoice_stats_mean_median_min_max.png)
...
![География продаж](revenue_and_max_check_by_country.png)
...
![Топ клиентов](top_purchases_and_clients_by_revenue.png)
